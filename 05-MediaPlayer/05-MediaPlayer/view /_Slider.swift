...
@IBDesignable
class _Slider: UISlider {
    
    @IBInspectable var minFillColor : UIColor = UIColor.lightGray {
        didSet {
            setNeedsDisplay()
        }
    }
    @IBInspectable var minStrokeColor : UIColor = UIColor.lightGray {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    @IBInspectable var thumbNormalStrokeColor : UIColor = UIColor.lightGray {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    @IBInspectable var thumbHighlightStrokeColor : UIColor = UIColor.lightGray {
        didSet {
            setNeedsDisplay()
        }
    }
